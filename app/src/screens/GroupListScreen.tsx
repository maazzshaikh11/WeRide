...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '700', color: WeRideColors.textPrimary },
  joinRow: { flexDirection: 'row', padding: 16, alignItems: 'center', gap: 8 },
  input: {
    flex: 1,
    borderWidth: 1,
    borderColor: WeRideColors.textSecondary,
    borderRadius: 8,
    padding: 12,
  ...
  joinButtonText: { color: WeRideColors.onPrimary, fontWeight: '600' },
  groupItem: {
    padding: 16,
    borderBottomWidth: 1,
    borderBottomColor: WeRideColors.background,
  },
  groupName: { fontSize: 16, fontWeight: '600', color: WeRideColors.textPrimary },
  groupMeta: { fontSize: 13, color: WeRideColors.textSecondary, marginTop: 4 },
  empty: { paddingVertical: 48, alignItems: 'center' },
  emptyText: { fontSize: 16, color: WeRideColors.textPrimary, fontWeight: '600' },
  emptySubtext: { fontSize: 13, color: WeRideColors.textSecondary, marginTop: 4 },
  fab: {
    position: 'absolute',
    bottom: 24,
    right: 24,
